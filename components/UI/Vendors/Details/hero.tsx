  ...
  return (
    <>
      <header className="min-h-[18rem] relative z-0 rounded-b-xl">
        ...
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-t from-black to-black/70 text-white">
          <p
          ...
          <div className="container h-full relative">
            <div className="size-32 rounded-full ring z-10 bg-white ring-white absolute -bottom-16 overflow-hidden">
              <Image
                src={"/images/home/beans-plantain.jpg"}
                alt="hero"
                width={300}
                height={300}
